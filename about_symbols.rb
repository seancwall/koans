...
class AboutSymbols < Neo::Koan
  ...
  # A: Because if you tried something like:
  #     Symbol.all_symbols.include?(:test_method_names_become_symbols)
  # it would always return true.  Comparing against the symbol you're looking
  # for (as a symbol) introduces it into the symbol table, thus guaranteeing it's always found.
  ...
  # A: Because you make too many symbols.  BAD!
end
