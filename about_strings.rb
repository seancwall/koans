...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # A: Using the shovel operator leads to less heap churn as you
    # are allocating fewer temporary strings.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # A: No.  In Ruby, there is no separate type for single characters.
    # They are just length 1 strings.
  end
