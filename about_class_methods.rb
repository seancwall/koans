...
class AboutClassMethods < Neo::Koan
  ...
  # A: Using the "class << self" method might be preferrable
  #    when you want to define multiple class methods in a row.
  #    This way you don't have to keep typing "self" for each
  #    method. The "def self.method" method might be preferrable
  #    when you want to define a single class method.
