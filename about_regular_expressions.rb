...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal "", "abbcccddddeeeee"[/e*/]

    # THINK ABOUT IT:
    #
    # When would * fail to match?
    # A: at the ends of a string, as shown in the last example above
  end
  ...
  #
  # Why?
  # A: Because they match as much as possible, as shown in the first example above
