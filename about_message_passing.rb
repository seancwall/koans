...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # A: send is a private method in Object class, so if you have a method named send in your class, you can't use it.
    #   __send__ is an alias for send, so you can use it instead of send.
  end
